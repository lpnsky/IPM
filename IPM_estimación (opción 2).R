...
ech$edu_escolaridad  <- ech$hh_escol_5 
...
ech$viv_tenencia  <- ech$ten_segura_2 
ech$viv_internet  <- ech$priv_internet 
ech$viv_problemas  <- ech$hh_problemas_vivienda 
ech$viv_cocina  <- ech$espacio_cocinar 
ech$viv_brechadig  <- ech$brecha_digital_2 
ech$trab_informalidad  <- ech$informales_al_menos_1 
ech$trab_calidad  <- ech$hh_empleo_opc_3 
...
ech$weighted_viv_brechadig  <- ech$viv_brechadig  *  ech$w_viv_brechadig
